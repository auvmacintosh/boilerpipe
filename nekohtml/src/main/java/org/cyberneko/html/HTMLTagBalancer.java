...
public class HTMLTagBalancer implements XMLDocumentFilter, HTMLComponent {
	...
	/** Recognized features. */
	private static final String[] RECOGNIZED_FEATURES = { NAMESPACES, AUGMENTATIONS, REPORT_ERRORS,
			DOCUMENT_FRAGMENT_DEPRECATED, DOCUMENT_FRAGMENT, IGNORE_OUTSIDE_CONTENT, };

	/** Recognized features defaults. */
	private static final Boolean[] RECOGNIZED_FEATURES_DEFAULTS = { null, null, null, null, Boolean.FALSE,
			Boolean.FALSE, };
	...
	public void startDocument(XMLLocator locator, String encoding, NamespaceContext nscontext, Augmentations augs)
		...
		if (fDocumentHandler != null) {
			XercesBridge.getInstance().XMLDocumentHandler_startDocument(fDocumentHandler, locator, encoding, nscontext,
					augs);
		}
	...
	public void endDocument(Augmentations augs) throws XNIException {
		...
		fIgnoreOutsideContent = true; // endElement should not ignore the
										// elements passed from buffer
	...
	public void startElement(final QName elem, XMLAttributes attrs, final Augmentations augs) throws XNIException {
		...
		// the creation of some elements like TABLE or SELECT can't be forced.
		// Any others?
