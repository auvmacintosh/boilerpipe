...
public abstract class CommonTagActions {
	...
	public static final TagAction TA_IGNORABLE_ELEMENT = new TagAction() {
		...
		public boolean start(final BoilerpipeHTMLContentHandler instance, final String localName, final String qName,
	...
	public static final TagAction TA_ANCHOR_TEXT = new TagAction() {
		...
		public boolean start(BoilerpipeHTMLContentHandler instance, final String localName, final String qName,
	...
	/**
	 * Special TagAction for the <code>&lt;FONT&gt;</code> tag, which keeps
	 * track of the absolute and relative font size.
	 */
