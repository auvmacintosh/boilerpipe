...
public final class ImageExtractor {
	 ...
	 */
	public List<Image> process(final TextDocument doc, final String origHTML) throws BoilerpipeProcessingException {
	 ...
	 * @throws BoilerpipeProcessingException
	 */
	public List<Image> process(final TextDocument doc, final InputSource is) throws BoilerpipeProcessingException {
