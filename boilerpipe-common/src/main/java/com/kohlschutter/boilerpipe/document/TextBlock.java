...
public class TextBlock implements Cloneable {
	...
	public String toString() {
		return "[" + offsetBlocksStart + "-" + offsetBlocksEnd + ";tl=" + tagLevel + "; nw=" + numWords + ";nwl="
				+ numWrappedLines + ";ld=" + linkDensity + "]\t" + (isContent ? "CONTENT" : "boilerplate") + ","
				+ labels + "\n" + getText();
	}
	...
	/**
	 * Returns the labels associated to this TextBlock, or <code>null</code> if
